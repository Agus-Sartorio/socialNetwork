...
function EditProfile({ userInfo }) {
  console.log(userInfo, 'sexooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo')
    ...
    <StyledEdit>
      ...
      <form onSubmit={(evt) => handleSubmit(evt)}>
        <div className='edit__images'>
          <div className='edit__portada'>
            <img
              ...
              onClick={update2}
              src={previewP ? `${process.env.REACT_APP_PUERTO}${userInfo.background_picture}` : userInfo.background_picture} alt='portada' />
          ...
          <div className='edit__avatar'>
            <img
              src={preview ? `${process.env.REACT_APP_PUERTO}${userInfo.profile}` : userInfo.profile}
        ...
        <div className='edit__container'>
          ...
          <label className='edit__description'>Descripcion
            <textarea
